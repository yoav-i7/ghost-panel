...
2. Configure the wrapper:
   Open `gpanel.cfg` in a text editor and edit the configuration variables to match your XFCE setup if necessary. By default, it targets Panel 1 with a height of 30 pixels.
